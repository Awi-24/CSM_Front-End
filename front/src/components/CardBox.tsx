...
const BoxCard: React.FC<BoxCardProps> = ({ icon, title, text, link }) => {
  return (
    <Link
      to={link}
      className=" bg-white xs:w-fit sm:w-fit md:w-60 rounded-lg p-4 m-10 text-center font-roboto shadow-md hover:shadow-lg transition duration-300 transform hover:-translate-y-1 hover:scale-105"
    >
      <div className="mb-4">
        <img
