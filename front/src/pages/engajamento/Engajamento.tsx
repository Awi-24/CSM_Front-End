...
function Engajamento() {
  return (
    <div className="  bg-landing w-full ">
      <div className=" p-10 h-full w-full bg-abrupt-gradient2">
      ...
      <div className=" font-robot font-medium pt-6 mx-20 text-white">
          {" "}
      ...
      <div className="bg-slate-50 text-center ">
        <p className="font-roboto text-center text-4xl  font-medium text-gray-900 pt-12">
          Voluntarie-se!
        </p>

        <div className=" font-robot font-medium pt-6 mx-20">
          {" "}
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Delectus
          odit ullam voluptates omnis. Quia ullam necessitatibus quisquam
          molestiae at facere, reiciendis eum recusandae, vel quasi nulla libero
        ...
        <button className="w-48 bg-blue-700 text-white my-11 hover:bg-blue-500 font-roboto font-medium py-2 px-6 rounded-md shadow-md focus:outline-none">
